...
import { FinalPhaseMatchForm } from "@/components/forms/final-phase-match-form";
...
export const MatchFinalPhase: React.FC<MatchClientProps> = ({
  data,
  categories,
  squads,
  fields,
                ...
                >
                  ...
                  {/* {!singleMatch.score_home && !singleMatch.score_away ? (
                    <DialogFooter>
                      <Button asChild>
                        <Link
                          href={`/admin/${slug}/final-phase/${singleMatch.id}`}
                        >
                          Modifica match
                        </Link>
                      </Button>
